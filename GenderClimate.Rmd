---
title: 'Towards Gender-Equitable Innovation: Assessing Local Conditions for Agricultural Targeting'
author: "Diana E. Lopez and Romain Frelat"
date: 'Last update: 11th December 2020'
output:
...
It is the accompanying tutorial for the article **Towards Gender-Equitable Innovation: Assessing Local Conditions for Agricultural Targeting** by Diana E. Lopez, Romain Frelat and Lone Badstue. See the *Materials and Methods* section of the article for more details about the data and the method.
...
The full GENNOVATE methodology and data collection instruments are available as a pdf [here](https://gennovate.org/wp-content/uploads/2018/10/GENNOVATE-Methodology_Feb2018_FINAL.pdf). 

The dataset containing the 32 variables is avalaible in the csv file  `GennovateWheatMaize.csv`, available for download [here](https://github.com/rfrelat/GenderClimate/raw/master/GennovateWheatMaize.csv)
...
Make sure you file `GennovateWheatMaize.csv` is in your working directory, and load it in R
